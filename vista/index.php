...
<body class="bodyindex">
                    ...
                    <strong>    
                            <ul class='menu__links'>
                                ...
                                elseif($_SESSION['tipo']=='usu'){
                                    ...
                                    <li class='menu__inside'>
                                        <a href='admin/rutas.php' class='menu__link menu__link--inside'>Rutas</a>
                                    </li>
                                    <li class='menu__inside'>
                                        <a href='login.php' class='menu__link menu__link--inside'>preferecias</a>
                                    </li>
    ...
    <section>  
        <section class="imagenes"> 
            <div class="slider">
                <ul class="sli">
                    <li><img src="../imagen/cutcsa 2.png" alt="" class="bus"></li>
                    <li><img src="../imagen/cutcsa 3.png" alt="" class="bus"></li>
                    <li><img src="../imagen/cutcsa.png" alt="" class="bus"></li>
                </ul>
            </div>
        </section>    

        <div class="noticias">
            <h1 class="prod">Noticias</h1>

            <div class="container">
                <a href="horarios.html">
                    <article class="card">
                        <strong><label>Nuevos horarios disponibles invierno 2023</label></strong>
                    </article>
                </a>
                <a href="#dos">
                <article class="card">
                    <strong><label>Paro general de omnibus este 22/9</label></strong>
                </article>
                </a>
            </div>    
        </div>
