...
<body class="bodyindex">
    ...
    <section class="addRutas" >
        <section class="reg_ver">
                <form id="viaje">
                    <label for="idViaje">id de viaje</label>
                    <input type="text" id="idViaje" name="idViaje" required autocomplete="off">
                    <label for="iniViaje">Sitio de inicio del viaje</label>
                    <input type="text" id="iniViaje" name="iniViaje" required autocomplete="off">
                    <label for="finViaje">Sitio final del viaje</label>
                    <input type="text" id="finViaje" name="finViaje" required autocomplete="off">
                    <label for="horSal">Horario de salida</label>
                    <input type="text" id="horSal" name="horSal" required autocomplete="off">
                    <label for="horLleg">Horario de llegada</label>
                    <input type="text" id="horLleg" name="horLleg" required autocomplete="off">
...
<script src="../../js/enviar_viaje.js"></script>
</body>
</html>