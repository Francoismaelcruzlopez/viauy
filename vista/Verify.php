...
<body class="bodyindex">
    <header>        
        ...
        <section class="reg_ver">
                <form id="verify">
                    <label for="veri">Ingrese aqui su codigo de verificación</label>
                    <input type="text" id="veri" name="veri" required autocomplete="off">
                    <p id="mensaje"></p>
...
<script src="../js/menu.js"></script>
<script src="../js/enviar_verify.js"></script>
</body>
</html>